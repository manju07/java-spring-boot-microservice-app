...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<?> resourceNotFoundException(ResourceNotFoundException ex, WebRequest request) {
    ErrorResponse errorDetails = new ErrorResponse(new Timestamp(System.currentTimeMillis()), HttpStatus.NOT_FOUND.toString(), ex.getMessage(),
  ...
  public ResponseEntity<?> globleExcpetionHandler(Exception exception, WebRequest request) {
    ErrorResponse errorDetails = new ErrorResponse(new Timestamp(System.currentTimeMillis()), HttpStatus.INTERNAL_SERVER_ERROR.toString(),
